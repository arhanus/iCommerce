...
const Footer = () => {
  return (
    <footer className="relative w-full border-[1px] py-8 bg-white">
      <div className="w-full px-8 mx-auto max-w-7xl lg:w-2/3">
        ...
        <div className="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-slate-200 md:flex-row md:justify-between">
          <p className="block mb-4 text-sm text-center text-slate-500 md:mb-0">
            Copyright © 2024 
            <a href="https://material-tailwind.com/"> iCommerce</a>. All
            Rights Reserved. | Made by Arhan Us
          </p>
